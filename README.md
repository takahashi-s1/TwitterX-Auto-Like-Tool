...
　約半年前にプログラミングを学び始めて、現在(2024年3月)まで学習を進める中で、ただ本やwebサイトに沿ったプロジェクトをこなすだけでなく、実社会、特にビジネス方面で必要とされる物、もしくはビジネスをより効率化させる物を自身で作成したいと考えました。特に、昨今のビジネスや副業において、SNSを利用して集客や企業認知度の向上を図っている方々が増えていると感じ、それらの業務をより効率化ニーズがあるのではないかと仮説を立てました。

　2つ目は、実際に私自身がXのアカウントを運用してみて、インプレッション数の増加（認知度拡大）を図る上で「いいね作業」が最も有効である一方で、多大な労力と時間を要する業務だと実感したからです。  
　まず私は、企業や個人がSNSを通してどのように集客・認知度向上を図っているか知るため、実際に0からXアカウントの運用を始めました。その結果、インプレッション数を大幅に増加させるには、フォロワー数という地盤を整え、Xのアルゴリズムに優遇される事が重要だと分かりました。また、そのフォロワー数を増やす為には、発信内容の工夫や、他アカウントのフォローよりも、自身のアカウントの運営方針に合致した内容のツイートに、積極的に「いいね」をして回る事が最も有効だと分かりました。しかし、これらの「いいね回り」は非常に地道で時間のかかる作業だと実感し、私と同じようにこれらの業務を効率化したいと思う方々に向けて制作する事を決意しました。  
...
　twitterが買収されて以降、長らく無料だったtwitter APIが有料化されました。basicプランで100ドル、proプランで5000ドルという料金に躊躇し、現在のアカウント運用に不便を感じている方々が多くいると考えました。このようなニーズを満たし、ビジネスでSNSを活用する方々に向けて、ルールや常識の範囲内でより業務を効率化する「いいね自動スクリプト」を提供したいと決意しました。
